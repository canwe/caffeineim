...
public class InterestsEnum {
	...
	private static Map<Integer, String> allInterests = new TreeMap<Integer, String>();	
	static {
	...
	public String toString() {
		if (allInterests.containsKey(getInterest())) {
			return allInterests.get(getInterest());
		}
		else {
			return "";
		}
	...
	public static String[] getAllInterests() {		
		return allInterests.values().toArray(new String[allInterests.size()]);
	}
}
