...
public class AffilationEnum {
	...
	private static Map<Integer, String> allAffiliations = new TreeMap<Integer, String>();
	static {
	...
	public String toString() {
		if (allAffiliations.containsKey(getAffiliation())) {
			return allAffiliations.get(getAffiliation());
		}
		else {
			return "";
		}
	...
	public static String[] getAllAffiliations() {		
		return allAffiliations.values().toArray(new String[allAffiliations.size()]);
	}
}
