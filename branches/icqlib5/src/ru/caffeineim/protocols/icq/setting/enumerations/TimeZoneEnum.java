...
public class TimeZoneEnum {
	...
	private static Map<Integer, String> timezones = new TreeMap<Integer, String>();
	...
	public String toString() {
		if (timezones.containsKey(getTimeZone())) {
			return timezones.get(getTimeZone());
		}
		else {
			return "";
		}
	...
	public static String[] getAllTimeZones() {		
		return timezones.values().toArray(new String[timezones.size()]);
	}
}
