...
public class OccupationEnum {
	...
	private static Map<Integer, String> allOccupations = new TreeMap<Integer, String>();
	static {
	...
	public String toString() {
		if (allOccupations.containsKey(getOccupation())) {
			return allOccupations.get(getOccupation());
		}
		else {
			return "";
		}
	...
	public static String[] getAllOccupations() {		
		return allOccupations.values().toArray(new String[allOccupations.size()]);
	}
}
