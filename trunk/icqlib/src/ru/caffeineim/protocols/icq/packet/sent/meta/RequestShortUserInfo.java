 ...
 */
public class RequestShortUserInfo extends Flap {
	
	private static final int REQUEST_LENGHT = 0x0E00;
	...
	public RequestShortUserInfo(String uinSearch, String uinForRequest) {
		...
		// Request SubType
		tlv.appendRawDataToTlv(new RawData(MetaSubTypeEnum.REQUEST_SHORT_USER_INFO, RawData.WORD_LENGHT));
