...
public class MetaSubTypeEnum {
	...
	public static final int SET_USER_BASIC_INFO              = 0xEA03;
	public static final int SET_USER_WORK_INFO               = 0xF303;
	public static final int SET_USER_MORE_INFO               = 0xFD03;
	public static final int SET_USER_NOTES_INFO              = 0x0604;
	public static final int SET_USER_EXTENDED_EMAIL_INFO     = 0x0B04;
	public static final int SET_USER_INTERESTS_INFO          = 0x1004;
	public static final int SET_USER_AFFILIATIONS_INFO       = 0x1A04;
	public static final int SET_USER_PERMISSIONS_INFO        = 0x2404;
	public static final int CHANGE_USER_PASSWORD             = 0x2E04;
	public static final int SET_USER_HOMEPAGE_CATEGORY_INFO  = 0x4204;
	public static final int REQUEST_FULL_USER_INFO           = 0xB204;
	public static final int REQUEST_SHORT_USER_INFO          = 0xBA04;
	public static final int UNREGISTER_USER                  = 0xC404;
	public static final int REQUEST_FULL_USER_INFO_2         = 0xD004;
	public static final int SEARCH_BY_DETAILS_PLAIN          = 0x1505;
	public static final int SEARCH_BY_UIN_PLAIN              = 0x1F05;
	public static final int SEARCH_BY_EMAIL_PLAIN            = 0x2905;
	public static final int WHITEPAGES_SEARCH_PLAIN_SIMPLE   = 0x3305;
	public static final int SEARCH_BY_DETAILS_PLAIN_WILDCARD = 0x3D05;
	public static final int SEARCH_BY_EMAIL_PLAIN_WILDCARD   = 0x4705;
	public static final int WHITEPAGES_SEARCH_PLAIN_WILDCARD = 0x5105;
	public static final int SEARCH_BY_UIN_TLV                = 0x6905;
	public static final int WHITEPAGES_SEARCH_TLV            = 0x5F05;
	public static final int SEARCH_BY_EMAIL_TLV              = 0x7305;
	public static final int RANDOM_CHAT_USER_SEARCH          = 0x4E07;
	public static final int REQUEST_SERVER_VARIABLE_VIA_XML  = 0x9808;
	public static final int SEND_REGISTRATION_STATS_REPORT   = 0xA50A;
	public static final int SEND_SHORTCUT_BAR_STATS_REPORT   = 0xAF0A;
	public static final int SAVE_INFO_TLV_BASED              = 0x3A0C;
	public static final int CLIENT_SEND_SMS                  = 0x8214;
	public static final int CLIENT_SPAM_REPORT               = 0x0820;
