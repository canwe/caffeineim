...
public class CountryEnum {
	...
	static {
        ...
        allCountries.put(CountryEnum.ANTIGUA_AND_BARBUDA, "Antigua and Barbuda");
        ...
        allCountries.put(CountryEnum.BRITISH_VIRGIN_ISLANDS, "British Virgin Islands");
        ...
        allCountries.put(CountryEnum.CENTRAL_AFRICAN_REPUBLIC, "Central African Republic");
        ...
        allCountries.put(CountryEnum.COCOS_KEELING_ISLANDS, "Cocos-Keeling Islands");
        ...
        allCountries.put(CountryEnum.CONGO_ZAIRE, "Congo, Democratic Republic of (Zaire)");
        ...
        allCountries.put(CountryEnum.COTE_D_IVOIRE, "Cote d'Ivoire (Ivory Coast)");
        ...
        allCountries.put(CountryEnum.IRAN, "Iran allCountries.put(Islamic Republic of)");
        ...
        allCountries.put(CountryEnum.MICRONESIA, "Micronesia, Federated States of");
        ...
        allCountries.put(CountryEnum.NETHERLANDS_ANTILLES, "Netherlands Antilles");
        ...
        allCountries.put(CountryEnum.SAINT_KITTS_AND_NEVIS, "Saint Kitts and Nevis");
        allCountries.put(CountryEnum.SAINT_LUCIA, "Saint Lucia");
        allCountries.put(CountryEnum.SAINT_PIERRE_AND_MIQUELON, "Saint Pierre and Miquelon");
        allCountries.put(CountryEnum.SAINT_VINCENT, "Saint Vincent and the Grenadines");
        allCountries.put(CountryEnum.SAIPAN_ISLAND, "Saipan Island");
        allCountries.put(CountryEnum.SAN_MARINO, "San Marino");
        allCountries.put(CountryEnum.SAO_TOME_AND_PRINCIPE, "Sao Tome and Principe");
        ...
        allCountries.put(CountryEnum.SYRIAN_ARAB_REPUBLIC, "Syrian Arab Republic");
        ...
        allCountries.put(CountryEnum.TRINIDAD_AND_TOBAGO, "Trinidad and Tobago");
        ...
        allCountries.put(CountryEnum.TURKS_AND_CAICOS_ISLANDS, "Turks and Caicos Islands");
        ...
        allCountries.put(CountryEnum.UNITED_ARAB_EMIRATES, "United Arab Emirates");
        ...
        allCountries.put(CountryEnum.VIRGIN_ISLANDS, "Virgin Islands allCountries.put(USA)");
        allCountries.put(CountryEnum.WALES, "Wales");
        allCountries.put(CountryEnum.WALLIS_AND_FUTUNA_ISLANDS, "Wallis and Futuna Islands");
